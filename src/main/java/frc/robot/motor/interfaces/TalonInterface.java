...
public class TalonInterface implements MotorInterface {
    private TalonFX motor;

    public TalonInterface(int deviceId) {
        this.motor = new TalonFX(deviceId);
    }
    public TalonInterface(int deviceId, CANBus bus) { // CANBus, because String was just too convenient huh
